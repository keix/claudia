...
pub fn runAllTests() void {
    uart.puts("=== Running Debug Tests ===\n");
    testMemorySystem();
    testVirtualMemorySystem();
    testFileSystem();
    testUserMode();
    uart.puts("=== Debug Tests Complete ===\n");
}

pub fn testProcessSystem() void {
...
pub fn testVirtualMemorySystem() void {
