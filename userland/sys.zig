...
pub const stat = @import("syscalls/io/stat").stat;
pub const fstatat = @import("syscalls/io/stat").fstatat;
pub const AT_FDCWD = @import("syscalls/io/stat").AT_FDCWD;
pub const dup = @import("syscalls/io/dup").dup;
pub const dup2 = @import("syscalls/io/dup").dup2;
